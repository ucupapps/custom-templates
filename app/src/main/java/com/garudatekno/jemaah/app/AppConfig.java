...
//	public static String URL_GET_POI= "http://192.168.0.10/api/jemaah/get-poi?id=";
	...
	public static String URL_LOGIN = "https://gohajj.id/api/jemaah-free/login";
	public static String URL_LOGIN_SOCIAL = "https://gohajj.id/api/jemaah-free/login-social";
	public static String URL_REGISTER = "https://gohajj.id/api/jemaah-free/register";
	public static String URL_PROFILE = "https://gohajj.id/api/jemaah-free/profile";
	public static String URL_GETPROFILE = "https://gohajj.id/api/jemaah-free/get-profile?id=";
	public static String URL_GET_PANDUAN = "https://gohajj.id/api/jemaah-free/get-panduan?id=";
	...
	public static String URL_GET_INBOX_VIEW = "https://gohajj.id/api/jemaah-free/get-inbox-view?id=";
	public static String URL_RATING= "https://gohajj.id/api/jemaah-free/rating";
	public static String URL_DOAKAN= "https://gohajj.id/api/jemaah-free/doakan";
	public static String URL_POI= "https://gohajj.id/api/jemaah-free/poi";
	public static String URL_POI_CAT= "https://gohajj.id/api/jemaah-free/poi-category";
	public static String URL_GET_POI= "https://gohajj.id/api/jemaah-free/get-poi?id=";
	public static String URL_KAMUS= "https://gohajj.id/api/jemaah-free/kamus";
	public static String URL_LIST_KAMUS= "https://gohajj.id/api/jemaah-free/list-kamus";
	public static String URL_PARAMS= "https://gohajj.id/api/jemaah-free/params";
	public static String URL_PUSATBANTUAN= "https://gohajj.id/api/jemaah-free/pusat-bantuan";
	public static String URL_GET_PUSATBANTUAN= "https://gohajj.id/api/jemaah-free/get-pusat-bantuan?id=";
	public static String URL_LAPORKAN_MASALAH= "https://gohajj.id/api/jemaah-free/laporkan-masalah";
	public static String URL_COUNT_INBOX= "https://gohajj.id/api/jemaah-free/count-inbox?id=";
	public static String URL_STATUS_INBOX= "https://gohajj.id/api/jemaah-free/status-inbox?id=";
	public static String URL_ADD_HOTEL= "https://gohajj.id/api/jemaah-free/add-hotel";
	public static String URL_SET_LOCATION= "https://gohajj.id/api/jemaah-free/set-location";
	public static String URL_LIST_HOTEL= "https://gohajj.id/api/jemaah-free/all-hotel";
	public static String URL_FIND_HOTEL= "https://gohajj.id/api/jemaah-free/find-hotel?name=";
	public static String URL_GET_DIR= "https://gohajj.id/api/jemaah-free/get-dir?name=";
