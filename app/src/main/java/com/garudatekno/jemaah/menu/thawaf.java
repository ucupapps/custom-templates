    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_setting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(thawaf.this, img_setting);
       ...
       //circle menu
        ...
        T_3=(TextView) findViewById(R.id.triangle_circle3);
        T_4=(TextView) findViewById(R.id.triangle_circle4);
        T_5=(TextView) findViewById(R.id.triangle_circle5);
...
//        Button btnSimple =(Button) findViewById(R.id.buttonSimple);
        ...
        C_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                resetBackground(); insertIntoDB("3",C_3,T_3);
            }
        });
        C_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                resetBackground(); insertIntoDB("4",C_4,T_4);
            }
        });
        C_5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                resetBackground(); insertIntoDB("5",C_5,T_5);
            }
        });
        C_6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                resetBackground(); insertIntoDB("6",C_6,T_6);
            }
        });
        C_7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                resetBackground(); insertIntoDB("7",C_7,T_7);
            }
        });
    ...
    protected void resetBackground(){
        ...
        T_3.setBackgroundResource(R.drawable.triangle_clear);
        T_4.setBackgroundResource(R.drawable.triangle_clear);
        T_5.setBackgroundResource(R.drawable.triangle_clear);
        T_6.setBackgroundResource(R.drawable.triangle_clear);
        T_7.setBackgroundResource(R.drawable.triangle_clear);
    ...
    protected void imgCenter(){
        ...
        if(stat.equals("1")){
            ...
            insertIntoDB("3",C_3,T_3);
        }else if(stat.equals("3")){
            insertIntoDB("4",C_4,T_4);
        }else if(stat.equals("4")){
            insertIntoDB("5",C_5,T_5);
        }else if(stat.equals("5")){
            insertIntoDB("6",C_6,T_6);
        }else if(stat.equals("6")){
            insertIntoDB("7",C_7,T_7);
    ...
    protected void insertIntoDB(String status,TextView circle,TextView triangle){
       ...
       database.execSQL(query);
        ...
        File file = new File("/sdcard/android/data/com.garudatekno.jemaah/thawaf/"+stat+".mp3");
...
//            insertIntoDB("2",C_2,T_2);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(thawaf.this, LoginActivity.class);
    ...
    private void startDownload(String id) {
        ...
        new thawaf.DownloadFileAsync().execute(url);
    }
    @Override
    ...
    class DownloadFileAsync extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... aurl) {
            ...
            try {
                ...
                OutputStream output = new FileOutputStream("/sdcard/android/data/com.garudatekno.jemaah/thawaf/"+id+".mp3");
