 ...
 */
public class CustomListPanduan extends SimpleAdapter {
    ...
    public CustomListPanduan(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        File file = new File("/sdcard/android/data/com.garudatekno.jemaah/"+strID+".mp3");

        if (!file.exists()) {
            txtaudio.setText("FALSE");
        }else{
            txtaudio.setText("TRUE");
        }
