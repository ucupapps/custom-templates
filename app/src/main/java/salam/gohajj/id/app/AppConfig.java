...
//	public static String URL_GET_POI= "http://192.168.0.10/api/jemaah/get-poi?id=";
    ...
    public static String URL_HOME = "http://192.168.0.4";
    public static String URL_LOGIN = "http://192.168.0.4/api/jemaah-free-new/login";
    public static String URL_LOGIN_SOCIAL = "http://192.168.0.4/api/jemaah-free-new/login-social";
    public static String URL_REGISTER = "http://192.168.0.4/api/jemaah-free-new/register";
    public static String URL_PROFILE = "http://192.168.0.4/api/jemaah-free-new/profile";
    public static String URL_GETPROFILE = "http://192.168.0.4/api/jemaah-free-new/get-profile?id=";
    public static String URL_GET_PANDUAN = "http://192.168.0.4/api/jemaah-free-new/get-panduan?id=";
    public static String URL_PANDUAN = "http://192.168.0.4/api/jemaah-free-new/panduan";
    public static String URL_PANDUAN_JENIS = "http://192.168.0.4/api/jemaah-free-new/panduan-jenis";
    public static String URL_TITIPAN_DOA = "http://192.168.0.4/api/jemaah-free-new/titipan-doa?id=";
    public static String URL_WEATHER = "http://192.168.0.4/api/jemaah-free-new/weather";
    public static String URL_EMERGENCY = "http://192.168.0.4/api/jemaah-free-new/emergency";
    public static String URL_GET_FAMILY_PHONE = "http://192.168.0.4/api/jemaah-free-new/family-phone?id=";
    public static String URL_GET_INBOX = "http://192.168.0.4/api/jemaah-free-new/get-inbox?id=";
    public static String URL_GET_INBOX_VIEW = "http://192.168.0.4/api/jemaah-free-new/get-inbox-view?id=";
    public static String URL_RATING= "http://192.168.0.4/api/jemaah-free-new/rating";
    public static String URL_DOAKAN= "http://192.168.0.4/api/jemaah-free-new/doakan";
    public static String URL_SEND_DOA= "http://192.168.0.4/api/jemaah-free-new/create-titipan-doa";
    public static String URL_POI= "http://192.168.0.4/api/jemaah-free-new/poi";
    public static String URL_POI_CAT= "http://192.168.0.4/api/jemaah-free-new/poi-category";
    public static String URL_GET_POI= "http://192.168.0.4/api/jemaah-free-new/get-poi?id=";
    public static String URL_KAMUS= "http://192.168.0.4/api/jemaah-free-new/kamus";
    public static String URL_LIST_KAMUS= "http://192.168.0.4/api/jemaah-free-new/list-kamus";
    public static String URL_PARAMS= "http://192.168.0.4/api/jemaah-free-new/params";
    public static String URL_PUSATBANTUAN= "http://192.168.0.4/api/jemaah-free-new/pusat-bantuan";
    public static String URL_GET_PUSATBANTUAN= "http://192.168.0.4/api/jemaah-free-new/get-pusat-bantuan?id=";
    public static String URL_LAPORKAN_MASALAH= "http://192.168.0.4/api/jemaah-free-new/laporkan-masalah";
    public static String URL_COUNT_INBOX= "http://192.168.0.4/api/jemaah-free-new/count-inbox?id=";
    public static String URL_STATUS_INBOX= "http://192.168.0.4/api/jemaah-free-new/status-inbox?id=";
    public static String URL_ADD_HOTEL= "http://192.168.0.4/api/jemaah-free-new/add-hotel";
    public static String URL_SET_LOCATION= "http://192.168.0.4/api/jemaah-free-new/set-location";
    public static String URL_LIST_HOTEL= "http://192.168.0.4/api/jemaah-free-new/all-hotel";
    public static String URL_FIND_HOTEL= "http://192.168.0.4/api/jemaah-free-new/find-hotel?name=";
    public static String URL_GET_DIR= "http://192.168.0.4/api/jemaah-free-new/get-dir?name=";
