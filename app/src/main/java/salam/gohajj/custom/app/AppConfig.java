package salam.gohajj.custom.app;
...
//	public static String URL_GET_POI= "http://192.168.0.10/api/jemaah/get-poi?id=";
    ...
    public static String URL_LOGIN = "https://dev.gohajj.id/api/jemaah-free-new/login";
    public static String URL_LOGIN_SOCIAL = "https://dev.gohajj.id/api/jemaah-free-new/login-social";
    public static String URL_REGISTER = "https://dev.gohajj.id/api/jemaah-free-new/register";
    public static String URL_PROFILE = "https://dev.gohajj.id/api/jemaah-free-new/profile";
    public static String URL_GETPROFILE = "https://dev.gohajj.id/api/jemaah-free-new/get-profile?id=";
    public static String URL_GET_PANDUAN = "https://dev.gohajj.id/api/jemaah-free-new/get-panduan?id=";
    public static String URL_PANDUAN = "https://dev.gohajj.id/api/jemaah-free-new/panduan";
    public static String URL_PANDUAN_JENIS = "https://dev.gohajj.id/api/jemaah-free-new/panduan-jenis";
    public static String URL_TITIPAN_DOA = "https://dev.gohajj.id/api/jemaah-free-new/titipan-doa";
    public static String URL_WEATHER = "https://dev.gohajj.id/api/jemaah-free-new/weather";
    public static String URL_EMERGENCY = "https://dev.gohajj.id/api/jemaah-free-new/emergency";
    public static String URL_GET_FAMILY_PHONE = "https://dev.gohajj.id/api/jemaah-free-new/family-phone?id=";
    public static String URL_GET_INBOX = "https://dev.gohajj.id/api/jemaah-free-new/get-inbox?id=";
    public static String URL_GET_INBOX_VIEW = "https://dev.gohajj.id/api/jemaah-free-new/get-inbox-view?id=";
    public static String URL_RATING= "https://dev.gohajj.id/api/jemaah-free-new/rating";
    public static String URL_DOAKAN= "https://dev.gohajj.id/api/jemaah-free-new/doakan";
    public static String URL_SEND_DOA= "https://dev.gohajj.id/api/jemaah-free-new/create-titipan-doa";
    public static String URL_POI= "https://dev.gohajj.id/api/jemaah-free-new/poi";
    public static String URL_POI_CAT= "https://dev.gohajj.id/api/jemaah-free-new/poi-category";
    public static String URL_GET_POI= "https://dev.gohajj.id/api/jemaah-free-new/get-poi?id=";
    public static String URL_KAMUS= "https://dev.gohajj.id/api/jemaah-free-new/kamus";
    public static String URL_LIST_KAMUS= "https://dev.gohajj.id/api/jemaah-free-new/list-kamus";
    public static String URL_PARAMS= "https://dev.gohajj.id/api/jemaah-free-new/params";
    public static String URL_PUSATBANTUAN= "https://dev.gohajj.id/api/jemaah-free-new/pusat-bantuan";
    public static String URL_GET_PUSATBANTUAN= "https://dev.gohajj.id/api/jemaah-free-new/get-pusat-bantuan?id=";
    public static String URL_LAPORKAN_MASALAH= "https://dev.gohajj.id/api/jemaah-free-new/laporkan-masalah";
    public static String URL_COUNT_INBOX= "https://dev.gohajj.id/api/jemaah-free-new/count-inbox?id=";
    public static String URL_STATUS_INBOX= "https://dev.gohajj.id/api/jemaah-free-new/status-inbox?id=";
    public static String URL_ADD_HOTEL= "https://dev.gohajj.id/api/jemaah-free-new/add-hotel";
    public static String URL_SET_LOCATION= "https://dev.gohajj.id/api/jemaah-free-new/set-location";
    public static String URL_LIST_HOTEL= "https://dev.gohajj.id/api/jemaah-free-new/all-hotel";
    public static String URL_FIND_HOTEL= "https://dev.gohajj.id/api/jemaah-free-new/find-hotel?name=";
    public static String URL_GET_DIR= "https://dev.gohajj.id/api/jemaah-free-new/get-dir?name=";
    ...
    public static final String URL_GET_ALL_CATEGORY = "http://demo.gohajj.com/id/view-category";
    public static final String URL_GET_ALL_KUESIONER = "http://demo.gohajj.com/id/get-kuesioner?id=";
