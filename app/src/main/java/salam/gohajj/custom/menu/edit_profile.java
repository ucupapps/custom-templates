...
//                    data.put(AppConfig.UPLOAD_KEY, uploadImageProfile);
                        ...
                        File image = new File(sdCardDirectory+"/android/data/salam.gohajj.custom/images/", uid+".png");
...
//                    //save image to sdcard
//                    File sdCardDirectory = Environment.getExternalStorageDirectory();
//                    File image = new File(sdCardDirectory+"/android/data/salam.gohajj.custom/images/", "profile.png");
//                    // Encode the file as a PNG image.
//                    FileOutputStream outStream;
//
//                    outStream = new FileOutputStream(image);
...
//                }
        ...
        if (getpref.equals(Interfaces.TEMPLATE_1)) {
            startActivity(new Intent(edit_profile.this, panduan.class));
            panduan.setTabIndex(4);
        }else{
