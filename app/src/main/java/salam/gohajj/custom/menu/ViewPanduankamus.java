...
public class ViewPanduankamus extends AppCompatActivity implements View.OnClickListener,ListView.OnItemClickListener {
    ...
    private void showData(String json){
        try {
            ...
            String arti = c.getString(AppConfig.KEY_TRANSLATION)!=null?c.getString(AppConfig.KEY_TRANSLATION):"";
            String arab = c.getString(AppConfig.KEY_ARAB)!=null?c.getString(AppConfig.KEY_ARAB):"";
            String ina = c.getString(AppConfig.KEY_INDONESIA)!=null?c.getString(AppConfig.KEY_INDONESIA):"";
            String file = c.getString(AppConfig.KEY_FILE)!=null?c.getString(AppConfig.KEY_FILE):"";
            txtid.setText(id);
