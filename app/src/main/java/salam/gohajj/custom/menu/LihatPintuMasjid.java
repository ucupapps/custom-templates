...
// FOOTER
        ...
        File file1 = new File("/sdcard/android/data/salam.gohajj.custom/images/"+uid+".png");
        if (!file1.exists()) {
        ...
        final File file = new File("/sdcard/android/data/salam.gohajj.custom/images/pintuMasjid.jpg");
        if (!file.exists()) {
