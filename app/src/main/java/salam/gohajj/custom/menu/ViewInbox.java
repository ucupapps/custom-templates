...
import salam.gohajj.custom.chat.CustomListView;
    ...
    private void showData(){
        ...
        try {
            ...
            for(int i = 0; i<result.length(); i++){
                ...
                String id = jo.getString(AppConfig.KEY_ID)!=null?jo.getString(AppConfig.KEY_ID):"";
                String message = jo.getString(AppConfig.KEY_MESSAGE)!=null?jo.getString(AppConfig.KEY_MESSAGE):"";
                String time = jo.getString(AppConfig.KEY_TIME)!=null?jo.getString(AppConfig.KEY_TIME):"";
                String from = jo.getString(AppConfig.KEY_FROM)!=null?jo.getString(AppConfig.KEY_FROM):"";
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ViewInbox.this,"",getResources().getString(R.string.mohon_tunggu)+"...",false,false);
            }
