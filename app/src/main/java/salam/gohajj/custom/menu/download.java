...
public class download extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        remove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                File folder1 = new File("/sdcard/android/data/salam.gohajj.custom/doa");
                File folder2 = new File("/sdcard/android/data/salam.gohajj.custom/sai");
                File folder3 = new File("/sdcard/android/data/salam.gohajj.custom/thawaf");
                        ...
                        public void run() {
                            ...
                            try {
                                for(int i = 0; i<result.length(); i++) {
                                    ...
                                    OutputStream output = new FileOutputStream("/sdcard/android/data/salam.gohajj.custom/"+folder+"/"+file);
    ...
    private void getJSON(final String name,final Button tombol){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                File folder = new File("/sdcard/android/data/salam.gohajj.custom/"+name);
                if (!folder.exists()) {
                    folder.mkdirs();
                }
